...
function ItemCardSlider() {
  return (
    <CategoryBodyContent>
        <div className="w-fit px-2 py-2 flex justify-start items-center gap-4">
            <ItemCard itemImg={cardOne} itemName="Item name" itemPrice="13$"/>
            <ItemCard itemImg={cardTwo} itemName="Item name" itemPrice="9$"/>
            <ItemCard itemImg={cardThree} itemName="Item name" itemPrice="9$"/>
            <ItemCard itemImg={cardFour} itemName="Item name" itemPrice="9$"/>
            <ItemCard itemImg={cardFive} itemName="Item name" itemPrice="9$"/>
            <ItemCard itemImg={cardOne} itemName="Item name" itemPrice="9$"/>
            <ItemCard itemImg={cardTwo} itemName="Item name" itemPrice="9$"/>
        </div>
    </CategoryBodyContent>
  )
